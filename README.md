...
- **Formulário com validação**: campos obrigatórios, máscaras/regex e feedback visual
- **Design System**: variáveis CSS (cores, tipografia, espaçamento), grid 12 colunas, componentes (cards, botões, badges)
